...
print(type.__call__(type,1))  # <class 'int'>

# type创建类
print(type("A",(),{})) # <class '__main__.A'>
print(type.__call__(type,"A",(),{})) # <class '__main__.A'>
...
print(A()) # <__main__.A object at 0x109000000>
print(type.__call__(A)) # <__main__.A object at 0x109000000>
...
这里看出,type的call方法就包含了对象创建的创建过程
"""
```
**任何实例调用都等于该实例类型调用__call__**
```python
class A:
    def __call__(self):
        return "I am A"
