# 元类
元类一般都是做工程架构才用得到的，对于初学者可以知道这个概念，之后随着功力增长或以后研究第三方源码的时候,就会get到这部分的思想。
...
# 定义plaer，元类是SingletonMeta，也是单例模式
    ...
    def __new__(mcs, name, bases, namespace):
        for k, v in namespace.items():
            if not k.startswith("_") and callable(v):
                namespace[k] = mcs.loggerWrapper(v)
