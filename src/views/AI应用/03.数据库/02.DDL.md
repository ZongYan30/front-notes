...
```sql
CREATE DATABASE courses_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';
...
CREATE TABLE public.students (
    ...
    gender character varying(10) CHECK (gender = ANY (ARRAY['男'::character varying, '女'::character varying, '未知'::character varying]))
);
```
