...
<img src="https://zongyan30.github.io/front-assets/agent/mcp.png">

to do list:

- `mcp` 独立配置  (agent/.agents/mcp.json)
- 进一步封装描述和工具  (agent/tool/use_mcp.py)
- 注册工具 
- 修改系统提示词模板和注入  (agent/prompt/system_prompt.j2) (prompt.py)
