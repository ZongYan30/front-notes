...
![购物车](https://zongyan30.github.io/front-assets/小兔鲜/cart_picture_1.png)
...
![购物车](https://zongyan30.github.io/front-assets/小兔鲜/cart_picture_2.png)
...
const onChangeCount = (ev: InputNumberBoxEvent) => {
  //购物车的数据建议放置在store中，在结算的时候，再向服务端发送请求。
  //按照现在这样处理，需要加上防抖会比较好，否则频繁的请求服务器，造成了资源浪费。
...
![购物车页](https://zongyan30.github.io/front-assets/小兔鲜/cart_picture_3.png)
