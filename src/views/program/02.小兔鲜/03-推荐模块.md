...
![热门推荐](https://zongyan30.github.io/front-assets/小兔鲜/hot_picture_1.png)
...
![Tab 交互](https://zongyan30.github.io/front-assets/小兔鲜/hot_picture_2.png)
...
const onScrolltolower = async () => {
  ...
  if (currsubTypes.goodsItems.page < currsubTypes.goodsItems.pages) {
    ...
    // 标记已结束
    currsubTypes.finish = true; ///为每个tab添加是否到底的标识
    // 退出并轻提示
  ...
  // 新的列表选项--累加到原数组中，currsubTypes是地址，赋值直接改变的是接口返回的数据subTypes
