...
<img src="https://zongyan30.github.io/front-assets/03-JS收官/20200827163636.png" alt="image-20200827163636508" style="zoom:50%;" />
...
```js
//1. 复制一个新对象出来，并且不改变原对象
const obj = { a: 1, b: 2, c: 3 };
const obj2 = { e: 5, f: 6 };
const newObj = Object.assign({}, obj, obj2); //将obj2合并到obj中，obj再合并到{}中，这样obj和obj2都不会更改
```
...
//arr.slice() 这里一定可以看出slice内部一定调用了this，所以我们把this指向obj
```
