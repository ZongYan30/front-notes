...
![](https://zongyan30.github.io/front-assets/12-webpack/2020-02-04-14-31-33.png)

看上去是不是和 LESS、SASS 一样呢？

但 PostCss 和 LESS、SASS 的思路不同，它其实只做一些代码分析之类的事情，将分析的结果交给插件，具体的代码转换操作是插件去完成的。

![](https://zongyan30.github.io/front-assets/12-webpack/2020-02-04-14-37-51.png)

官方的一张图更能说明 postcss 的处理流程：

![](https://zongyan30.github.io/front-assets/12-webpack/postcss-workflow.png)
...
![](https://zongyan30.github.io/front-assets/12-webpack/2020-02-05-14-37-11.png)
