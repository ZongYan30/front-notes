...
![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-13-10-39-24.png)

loader 函数的将在模块解析的过程中被调用，以得到最终的源码。

**全流程：**

![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-13-09-28-52.png)

**chunk 中解析模块的流程：**

![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-13-09-29-08.png)

**chunk 中解析模块的更详细流程：**

![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-13-09-35-44.png)

**处理 loaders 流程：**

![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-13-10-29-54.png)
...
1.**loaders 本质是一个函数，将源代码从一个字符串转换为另一个字符串。**

2.**loaders 中只能使用 common.js 规范，因为 loaders 是在 webpack 编译的时候被执行的，而 webpack 又是在 node 环境下执行的。**

3.**loaders 的匹配规则是从上往下的，但是执行 loaders 的时候却是从最后开始往前的。**

4.**大多数开发场景下，我们不需要自己写 loader,因为现在的 webpack 生态比较成熟，几乎 99%都有解决方案**

# 案例

> 写一个 loader,将 index.js 中的错误给替换掉
...
loader1.js 和 loader2.js 和 loader3.js
