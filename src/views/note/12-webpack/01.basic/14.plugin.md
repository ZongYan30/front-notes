...
![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-15-12-45-16.png)
...
![](https://zongyan30.github.io/front-assets/12-webpack/2020-01-15-12-49-26.png)
...
webpack 可以配置`watch:true`,来监听文件的变化，当文件改变时，webpack 不会再从初始化阶段重新开始打包了，而 compiler 却是在初始化阶段创建的，所以整个过程只有一个 compiler 对象。
...
**plugin 一般不需要我们去写，我们只需要知道运行原理即可，会使用就行。因为 plugin 太复杂了**
