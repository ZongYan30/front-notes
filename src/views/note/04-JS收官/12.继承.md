...
```js
function VIPUser(username, password, expires) {
  User.call(this, username, password); //使用call要把this指向修改为VipUser
  this.expires = expires;
}
```
...
<img src="https://zongyan30.github.io/front-assets/03-JS收官/20211214155347.png" alt="image-20211214155342118" style="zoom:50%;" />

仅需一句代码即可

```js
Object.setPrototypeOf(VIPUser.prototype, User.prototype); //其实本质就是为了让VIPUser的原型对象的隐式原型指向User的原型对象，从而形成原型链(替换调默认指向的Object的原型对象)
```
