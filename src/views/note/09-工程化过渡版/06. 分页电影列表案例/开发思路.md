...
![image-20210510105351710](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510105351.png)

# 分包

如果站点中的所有依赖都打包到一个 js 文件中，势必会导致打包结果过大

![image-20210510110356818](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510110356.png)
...
![image-20210510110909513](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510110909.png)

在浏览器运行时，会首先加载初始的打包结果，然后在后续的运行过程中，动态加载其他模块。这样就可以尽量提升初始加载效率，又不影响后续模块的加载

![image-20210510111343103](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510111343.png)
...
![image-20210510123323486](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510123323.png)

你无须彻底理解上图，只需要知道：**最终部署之后，不存在跨域问题**

但是，**跨域问题在开发阶段是存在的**！

![image-20210510123708048](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510123752.png)
...
![image-20210510124724077](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510124724.png)

这样一来，在跨域问题上，就做到了**开发环境和生产环境的统一**

![image-20210510125000499](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510125000.png)

# 电影模块

![image-20210510134430136](https://zongyan30.github.io/front-assets/09-工程化过渡版/20210510134430.png)
