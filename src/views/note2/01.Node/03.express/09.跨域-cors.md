# cors
> cors是常见的解决跨域的方式，推荐使用，一般我们会使用cors中间件。
...
![image-20200421152122793](https://zongyan30.github.io/front-assets/Node/cors2.png)
...
![image-20200421162846480](https://zongyan30.github.io/front-assets/Node/cors3.png)
...
![image-20200421165913320](https://zongyan30.github.io/front-assets/Node/cors1.png)
...
app.use(require("./corsMiddleware"));//一般都会在其他中间件之前使用

//其他中间件
```

## 使用第三方库cors
`cors`实际上是一个中间件，用于处理跨域请求。
