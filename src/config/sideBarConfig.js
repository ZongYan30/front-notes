...
export default {
  ...
  "/AI应用/04.数据科学/": set_sidebar("/src/views/AI应用/04.数据科学"),
  "/AI应用/05.Agents原理/": set_sidebar("/src/views/AI应用/05.Agents原理"),
  "/AI应用/06.LangGraph/": set_sidebar("/src/views/AI应用/06.LangGraph"),
  //项目模块
